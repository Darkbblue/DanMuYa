...
QT_MOC_LITERAL(1, 12, 15), // "StartConnection"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4), // "port"
QT_MOC_LITERAL(4, 34, 21) // "on_pushButton_clicked"

    },
    "StartWindow\0StartConnection\0\0port\0"
...
void StartWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartWindow::StartConnection)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StartWindow::StartConnection(int _t1)
{
